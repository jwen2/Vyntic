...
SAMPLE_DEALS = [
    ...
    # Brightwater / Glenmoor: a two-fund manager with a full LP document set.
    # Generated by scripts/generate_brightwater_docs.py with deliberate planted
    # inconsistencies (see output/MANIFEST.md) and used as the substrate for the
    # citation-accuracy golden set in evals/data/brightwater_golden_set.json.
    # Fund IV holds the manager-scoped documents; they resolve into Fund III's
    # context through context_provider._manager_shared_doc_rows.
    {
        "deal_id": "brightwater_iv",
        "name": "Brightwater Capital Partners IV",
        "description": "2026 vintage, $1.25B target / $1.5B hard cap. Fund IV selection diligence demo.",
        "stage": "Diligence",
        "tags": ["Synthetic QA", "Industrials"],
        "entity_type": "fund",
        "manager": {
            "manager_id": "brightwater_capital",
            "name": "Brightwater Capital Partners, LLC",
            "description": "Chicago-based North American industrials and business services manager, founded 2009, ~$2.1B AUM. Fictional demo GP.",
            "tags": ["Synthetic QA", "Buyout"],
        },
        "vintage": 2026,
        "strategy": "Buyout",
        "files": [
            "brightwater_iv_lpa.pdf",
            "brightwater_iv_ddq.pdf",
            "brightwater_iv_ppm.pdf",
            "brightwater_iv_pitchbook.pdf",
            "brightwater_adv_part2a.pdf",
            "brightwater_valuation_policy.pdf",
            "brightwater_track_record.xlsx",
        ],
        "document_metadata": {
            "brightwater_iv_lpa.pdf": {"doc_category": "lpa", "scope": "entity"},
            "brightwater_iv_ddq.pdf": {"doc_category": "ddq", "scope": "entity"},
            "brightwater_iv_ppm.pdf": {"doc_category": "ppm", "scope": "entity"},
            "brightwater_iv_pitchbook.pdf": {"doc_category": "pitchbook", "scope": "entity"},
            "brightwater_adv_part2a.pdf": {"doc_category": "form_adv", "scope": "manager"},
            "brightwater_valuation_policy.pdf": {"doc_category": "valuation_policy", "scope": "manager"},
            "brightwater_track_record.xlsx": {"doc_category": "track_record", "scope": "manager"},
        },
    },
    {
        "deal_id": "brightwater_iii",
        "name": "Brightwater Capital Partners III",
        "description": "2021 vintage, $850M. Glenmoor holds a $25M commitment; monitoring demo.",
        "stage": "Monitoring",
        "tags": ["Synthetic QA", "Industrials"],
        "entity_type": "fund",
        "manager": {
        ...
        "strategy": "Buyout",
        "files": [
            "glenmoor_fund_iii_side_letter.pdf",
            "glenmoor_fund_iii_pcap_q2_2026.pdf",
            "brightwater_iii_quarterly_q2_2026.pdf",
            "brightwater_iii_audited_fs_2025.pdf",
            "brightwater_iii_capital_call_07.pdf",
            "brightwater_iii_distribution_03.pdf",
        ],
        "document_metadata": {
            "glenmoor_fund_iii_side_letter.pdf": {"doc_category": "side_letter", "scope": "entity"},
            "glenmoor_fund_iii_pcap_q2_2026.pdf": {"doc_category": "capital_account", "scope": "entity", "period": "Q2 2026"},
            "brightwater_iii_quarterly_q2_2026.pdf": {"doc_category": "quarterly_report", "scope": "entity", "period": "Q2 2026"},
            "brightwater_iii_audited_fs_2025.pdf": {"doc_category": "financial_statements", "scope": "entity", "period": "FY2025"},
            "brightwater_iii_capital_call_07.pdf": {"doc_category": "capital_call", "scope": "entity", "period": "Q3 2026"},
            "brightwater_iii_distribution_03.pdf": {"doc_category": "distribution_notice", "scope": "entity", "period": "Q3 2026"},
        },
    },
]
