...
- Badge/Pill primitives remain future work. Input/Select/Textarea and read-only table chrome have shipped; interactive grid chrome is tracked separately in `docs/todo/2026-07-27-interactive-grid-chrome.md`.
