...
| DS-Grid | `2026-07-27-interactive-grid-chrome.md` | Extract shared interactive-grid chrome for Doc Matrix and Tabular Run while preserving sticky columns, resize handles, reorder, selection, retry, streaming, and memoization behavior | DS app primitive rollout | **only remaining UI fidelity item** |
