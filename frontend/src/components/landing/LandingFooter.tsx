      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            ...
            <p className="mt-4 text-sm text-gray-500 max-w-xs leading-relaxed">
              AI-powered deal intelligence for private equity. Screen faster,
              analyze deeper, decide with confidence.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gray-600">
            &copy; {new Date().getFullYear()} Vyntic, Inc. All rights reserved.
          </p>
          <p className="text-xs text-gray-600">
            Built for PE analysts, by PE analysts.
          </p>
        </div>
      </div>
    </footer>
