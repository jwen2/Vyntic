...
export default function LeftSidebar({
  ...
  return (
    ...
    >
      ...
      {/* Findings section demoted 2026-05-12. Sidebar shows Documents + Coverage only.
          Findings still persist in localStorage and feed the deal-breaker pill in
          TopBar; surfacing them in a richer view (or inside Proactive Scan output)
          is a follow-up. */}
        </>
      )}
    </aside>
